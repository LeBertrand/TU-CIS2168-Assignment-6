 ...
 * Assignment 6
 * BinarySearchTree
 * Use JUnit tools to test reliability of methods for finding depth of
 * minimum value in BST and checking that two trees have the same structure.
 * Several steps of modifying trees, asserting something, printing trees,
 * and printing report summarizing assertion that just passed.
 */
